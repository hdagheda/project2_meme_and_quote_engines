...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Generate a meme from an image and an optional quote.")
    parser.add_argument("--path", type=str, nargs=1, default=None, help="Path to an image file.")
